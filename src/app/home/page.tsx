...
import { faTruck, faPiggyBank, faMoneyBill, faUserGear, faChartBar, faChartPie, faChartSimple, faBuildingColumns, faBuildingUser, faCreditCard, faCalendar, faWallet, faCalendarDay, faMapLocationDot, faList } from "@fortawesome/free-solid-svg-icons";
